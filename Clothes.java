...
public class Clothes extends Setting implements Items{
	...
	// 아이템 추가 메소드
		...
		public void addItem(User user) throws IOException {
			...
			// 기본 목록 _user version
			String userFileName = "C:/Java_Lab/Project/src/market/items/clothes_user.txt";
			...
			// 기본 목록_admin version
			String adminFileName = "C:/Java_Lab/Project/src/market/items/clothes_admin.txt";
		...
		public void deleteItem(String num, User buyer) throws IOException {
			...
			fileName = "C:/Java_Lab/Project/src/market/items/clothes_admin.txt";
			...
			fileName = "C:/Java_Lab/Project/src/market/items/clothes_user.txt";
			br = new BufferedReader(new FileReader(fileName));
		...
		public void showItems() throws IOException {
			String fileName = "C:/Java_Lab/Project/src/market/items/clothes_user.txt";
			BufferedReader br = new BufferedReader(new FileReader(fileName));
